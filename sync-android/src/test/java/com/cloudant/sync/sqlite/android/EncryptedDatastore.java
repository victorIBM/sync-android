 ...
 * {@link com.cloudant.sync.datastore.DatastoreExtended} interface, which allow for various querying models
 ...
 * this class operating on {@link com.cloudant.sync.datastore.BasicDocumentRevision} objects, which carry both a
 ...
 * the {@link EncryptedDatastore#deleteDocumentFromRevision(com.cloudant.sync.datastore.BasicDocumentRevision)}
 * method. When the
 ...
 * peers.</p>
 *
 * @see com.cloudant.sync.datastore.DatastoreExtended
 * @see com.cloudant.sync.datastore.BasicDocumentRevision
 *
 */
public interface EncryptedDatastore {
     ...
     * (via tombstones, see {@link EncryptedDatastore#deleteDocumentFromRevision(com.cloudant.sync.datastore.BasicDocumentRevision)})
     * </p>
     *
     ...
     *                 conflicts
     * @throws com.cloudant.sync.datastore.ConflictException Found new conflicts while
     ...
     * @see EncryptedDatastore#getEventBus()
     */
     ...
     * @throws com.cloudant.sync.datastore.ConflictException <code>rev</code> is not a current revision for this document
     * @throws com.cloudant.sync.datastore.AttachmentException if there is a problem saving any new attachments
     ...
     * leaf revision of a document. {@link EncryptedDatastore#resolveConflictsForDocument} handles this
     ...
     * @throws com.cloudant.sync.datastore.ConflictException if the <code>sourceRevisionId</code> is not the current revision
     * @see EncryptedDatastore#getEventBus()
     * @see EncryptedDatastore#resolveConflictsForDocument
     */
     ...
     * {@link EncryptedDatastore#deleteDocumentFromRevision(com.cloudant.sync.datastore.BasicDocumentRevision)
     ...
     * @throws com.cloudant.sync.datastore.ConflictException
     * @throws com.cloudant.sync.datastore.DocumentException if there was an error deleting the document
     * @see EncryptedDatastore#getEventBus()
     * @see EncryptedDatastore#deleteDocumentFromRevision(com.cloudant.sync.datastore.BasicDocumentRevision)
     */
